...
//  @Mock static ElasticsearchService esService;
...
//            verify(esService, times(1)).createMlayerInstance(any(), any());
...
//    mlayerService = new MlayerServiceImpl(esService, postgresService, jsonObject);
...
//        handler -> {
//          if (handler.succeeded()) {
//            verify(esService, times(1)).getMlayerInstance(any(), any());
//            testContext.completeNow();
//          } else {
//            LOGGER.debug("Fail");
//            testContext.failNow(handler.cause());
...
//        handler -> {
//          if (handler.succeeded()) {
//            verify(esService, times(1)).deleteMlayerInstance(any(), any());
//            testContext.completeNow();
//          } else {
//            LOGGER.debug("Fail");
//            testContext.failNow(handler.cause());
...
//        handler -> {
//          if (handler.succeeded()) {
//            verify(esService, times(1)).updateMlayerInstance(any(), any());
//            testContext.completeNow();
//          } else {
//            LOGGER.debug("Fail");
//            testContext.failNow(handler.cause());
...
//        handler -> {
//          if (handler.succeeded()) {
//            verify(esService, times(1)).createMlayerDomain(any(), any());
//            testContext.completeNow();
//
//          } else {
//            LOGGER.debug("Fail");
...
//        handler -> {
//          if (handler.succeeded()) {
//            verify(esService, times(1)).updateMlayerDomain(any(), any());
//            testContext.completeNow();
//
//          } else {
//            LOGGER.debug("Fail");
...
//        handler -> {
//          if (handler.succeeded()) {
//            verify(esService, times(1)).deleteMlayerDomain(any(), any());
//            testContext.completeNow();
//          } else {
//            LOGGER.debug("Fail");
//            testContext.failNow(handler.cause());
...
//        handler -> {
//          if (handler.succeeded()) {
//            verify(esService, times(1)).getMlayerDomain(any(), any());
//            testContext.completeNow();
//          } else {
//            LOGGER.debug("Fail");
//            testContext.failNow(handler.cause());
...
//        handler -> {
//          if (handler.succeeded()) {
//            verify(esService, times(1)).getMlayerProviders(any(),any());
//            testContext.completeNow();
//          } else {
//            LOGGER.debug("Fail");
//            testContext.failNow(handler.cause());
...
//        handler -> {
//          if (handler.succeeded()) {
//            verify(esService, times(1)).getMlayerGeoQuery(any(), any());
//            testContext.completeNow();
//          } else {
//            LOGGER.debug("Fail");
//            testContext.failNow(handler.cause());
...
//       request, handler -> {
//          if (handler.succeeded()) {
//            verify(esService, times(1)).getMlayerAllDatasets(any(), any(), any());
//            testContext.completeNow();
//          } else {
//            LOGGER.debug("Fail");
//            testContext.failNow(handler.cause());
...
//        handler -> {
//          if (handler.succeeded()) {
//            verify(esService, times(1)).getMlayerDataset(any(), any());
//            testContext.completeNow();
//
//          } else {
//            LOGGER.debug("Fail");
...
//        handler -> {
//          if (handler.succeeded()) {
//            verify(esService, times(1)).getMlayerPopularDatasets(any(), any(), any());
