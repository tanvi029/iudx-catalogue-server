...
public class AttributeSearchIT {
    ...
    void GetSimpleAttributeExceedPropQueryParam() {
        given()
                ...
                .param("value","[[af19727d-0ab8-4002-b745-ec183cb0ce60],[sensor1],[aqm],[pune],[1234],[abc],[abc],[pune],[a29b0d99-5578-43a0-a354-04a6d0d6c8df],[a29b0d99-5578-43a0-a354-04a6d0d6c8df],[ACTIVE]]")     .when()
                .get("/search")
                .then()
                .statusCode(400)
    ...
    void GetSimpleAttributeExceedValPairQueryParam() {
        given()
                ...
                .param("value","[[af19727d-0ab8-4002-b745-ec183cb0ce60],[sensor1],[aqm],[pune],[1234],[1234],[1234],[1234],[1234],[1234],[1234],[1234],[1234],[1234],[1234],[1234],[1234],[1234],[1234],[1234],[1234]]")                .when()
                .get("/search")
                .then()
                .statusCode(400)
                .body("title", is("failed"));
    ...
    void GetSimpleAttributeExceedValQueryParam() {
        given()
                .param("property","[id,name,tags,location]")
                .param("value","[[af19727d-0ab8-4002-b745-ec183cb0ce60],[sensor1,sensor2,sensor3,sensor4,sensor5,sensor1,sensor2,sensor3,sensor4,sensor5,sensor1,sensor2,sensor3,sensor4,sensor5,sensor1,sensor2,sensor3,sensor4,sensor5,sesor5],[aqm],[pune]]")                .when()
                .get("/search")
                .then()
                .statusCode(400)
                .body("title", is("failed"));
