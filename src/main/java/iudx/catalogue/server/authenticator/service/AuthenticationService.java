...
public interface AuthenticationService {
   ...
   * <p>
   * This method performs the decoding of a JWT (JSON Web Token) to extract the user information
   * and claims embedded in the token, such as user roles, issuer, subject, etc.
   * </p>
   *
   * @param token  {@link String} token to be decoded
   * @return a {@link Future} of {@link JwtData} which will contain the decoded token data
