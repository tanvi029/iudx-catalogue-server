  ...
  stages {
    ...
    stage('Unit Tests and CodeCoverage Test'){
      steps{
        script{
          ...
          sh 'cp /home/ubuntu/configs/cat-refactor-test.json ./configs/cat-refactor-test.json'
    ...
    stage('Integration Tests and OWASP ZAP pen test'){
      steps{
        ...
        script{
            sh 'sudo update-alternatives --set java /usr/lib/jvm/java-21-openjdk-amd64/bin/java'
            sh 'scp /home/ubuntu/configs/cat-refactor-test.json ./configs/cat-refactor-test.json'
